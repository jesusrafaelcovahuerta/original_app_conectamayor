                            ...
                            <form @submit.prevent="onSubmit" ref="createBill" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6" v-if="form.link_question_id == 1">
                                        ...
                                        <input
                                            type="text" 
                                            v-mask="'http://XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXx'"
                                            v-model="form.url" 
                                            class="form-control"
